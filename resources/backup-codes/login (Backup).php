        ...
        <div class="login login-v2" data-pageload-addclass="animated fadeIn" style="background-color: white">
            ...
            <div class="login-header">
                <div class="brand" style="color: black; text-align: center">
                    ...
                    <img src="resources/images/logo.png" style="width:45%; margin-top: 10px" alt="">
                    <small style="color: black">Province of Batangas</small>
                    <small style="color: black; font-size: 19px">Municipality of Tuy</small>
                    <b style="font-size: 26px">Urban Planning Development System
                </div>
                <div class="icon">
