    ...
    <title>Applicants' Report | MUPDS</title>
<?php
...
?>
        ...
        <div id="content" class="content">
            <!-- begin breadcrumb -->
                <ol class="breadcrumb pull-right">
                    ...
                    <li class="breadcrumb-item active">View Applicant Report</li>
                </ol>
            <!-- end breadcrumb -->
            <!-- begin page-header -->
                <h1 class="page-header">Applicant's Report View</h1>
            <!-- end page-header -->
            <!--Line Divider-->
            ...
            <div class="panel panel-inverse">
                        ...
                        <div class="col-md-12" style="border:1px solid; background-color: #242424;">
                            ...
                            <form action="" method="POST">
                                <div class="row" style="margin: 10px">
                                    <div class="col-md-4">
                                        <label style="color: white">Filter by Month of Registration</label>
                                        <div class="row">
                ...
                <div class="panel-body">
                    <div class="panel-heading" style="background-color: #242424">
                        <h2 class="panel-title" style="color: white">Registered Applicants</h2>
                    </div>
                    <!--FILTER START-->
                    <div class="row" style="margin:3px">
    ...
    <?php include("applicant_report_printable.php");?>
   </body>
</html>
<!-- ======= ON PAGE SCRIPT ======== -->
<!-- <script>
