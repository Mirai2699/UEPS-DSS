<table id="data-table-default" class="table table-striped table-bordered">
  ...
  <?php
      $view_query = mysqli_query($connection,"SELECT * FROM `t_zoning_application` AS ZA 
                                              ...
                                              WHERE ZA.za_app_status = 'APPROVED'
      ...
      while($row = mysqli_fetch_assoc($view_query))
      {
          ...
          $za_approved_timestamp = new datetime($row["za_approved_timestamp"]); 
          ...
          $newdate_approved = $za_approved_timestamp->format('F d, Y');
  ?>      
      <tr class="gradeX">
          ...
          <td width=""><?php echo $newdate_approved; ?></td>
          <td style="text-align:center">
            <a href="zone_app_closed_view_details.php?getID=<?php echo $za_ID?>" class="btn btn-primary " title="Review Details">
