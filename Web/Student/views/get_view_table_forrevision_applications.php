<table id="data-table-default" class="table table-striped table-bordered">
  ...
  <?php
      ...
      while($row = mysqli_fetch_assoc($view_query))
      {
          ...
          $za_mod_timestamp = new datetime($row["za_mod_timestamp"]); 
          ...
          $newmoddate = $za_mod_timestamp->format('F d, Y');
  ?>      
      <tr class="gradeX">
          ...
          <td width=""><?php echo $newmoddate; ?></td>
          <td width=""><?php echo $za_app_remarks; ?></td>
