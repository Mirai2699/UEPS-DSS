 <?php
  $view_query = mysqli_query($connection,"SELECT * FROM `t_zoning_application` AS ZA 
                                                ...
                                                ON ZA.za_app_mapping_expert = ACC.acc_ID
      ...
      while($row = mysqli_fetch_assoc($view_query))
      {
          ...
          $za_area_loc_display = '('.$za_project_area.' sq.m2) '.$za_loc_number.', '.$za_loc_street.' St., Brgy.'.$brgy_name.', '.$munic_name.', '.$za_loc_province;
