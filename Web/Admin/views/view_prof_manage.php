    ...
    <title>Profile Management | MUPDS</title>
<?php
        ...
        <div id="content" class="content">
            <!-- begin breadcrumb -->
                <ol class="breadcrumb pull-right">
                    ...
                    <li class="breadcrumb-item active">view profiles</li>
                </ol>
            <!-- end breadcrumb -->
            <!-- begin page-header -->
	            ...
	            <div class="panel panel-inverse">
	                <div class="panel-heading">
	                    <h2 class="panel-title" style="margin: 10px">
	                        <i class="fa fa-users"></i>&nbsp;&nbsp;&nbsp;View Profile Details
	                    </h2>
	                </div>
	                <div class="panel-body">
	                  <div class="col-md-12">
	                      <div class="panel">
	                          <?php include("get_view_table_profiles.php");?>	
	                      </div>
	                  </div>
	                </div>
	                <!--FIRST PART-->
